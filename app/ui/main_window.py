...
class MainWindow:
    ...
    def _setup_ui(self) -> None:
        ...
        ttk.Button(top, text="Diagnostic local", command=self.run_local_diagnostics).pack(side=tk.LEFT, padx=4)
    ...
    def run_local_diagnostics(self) -> None:
        checker = LocalHealthChecker(
        ...
        msg = "\n".join(lines)
        self._status("Diagnostic local exécuté")
        messagebox.showinfo("Diagnostic local", msg)
